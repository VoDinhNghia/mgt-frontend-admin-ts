...
import { IregisterInputLearningRateForm, registerSchemaLearningRateForm } from "../../../../utils/setting.util";
          ...
          (
            <form onSubmit={handleSubmit(onSubmitHandlerAdd)}>
              ...
              <TextField
                ...
                {...register("maximum")}
              />
              <Button variant="contained" className="w-100 mt-4" type="submit">SAVE</Button>
            </form>
          )
        : ""}
      </DialogContent>
